...
report 50035 "NUB Aged Accounts Receivable"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Layout/NUBAgedAccountsReceivable.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'NUB Aged Accounts Receivable';
    ...
    var
        ...
        DataLbl: Label 'Data';
        AgedAccountsReceivableLbl: Label 'NUB Aged Accounts Receivable';
    ...
    begin
        ...
        ExcelBuf.AddInfoColumn(REPORT::"NUB Aged Accounts Receivable", false, false, false, false, '', ExcelBuf."Cell Type"::Number);
        ExcelBuf.NewRow();
    ...
    begin
        ...
        if PrintDetail then begin
            ...
            ExcelBuf.AddColumn(Format(SalesPersonCodeLbl), false, '', true, false, true, '', ExcelBuf."Cell Type"::Text);
    ...
    begin
        ...
        /* if OverLimitDescription = '' then
            ExcelBuf.AddColumn(Customer."Salesperson Code", false, '', false, false, false, '#,##0', ExcelBuf."Cell Type"::Number)
        else
    ...
    begin
        ...
        ExcelBuf.CreateNewBook(AgedAccountsReceivableLbl);

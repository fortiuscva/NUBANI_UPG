report 50026 "Customer catalog (Sales Quote)"
{
    // NUB1.01,04-Sep-15,ST: Created new report which is replica of report 50025 with different layout for sales quote.
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Layout/CustomercatalogSalesQuote.rdl';
...
#pragma warning restore AL0432
            ...
            begin
                IF PrintCompany THEN BEGIN
                    ...
                    END;
                END;
                CurrReport.LANGUAGE := EventsandSubscribersB2B.GetLanguageID("Language Code");
    ...
    var
        ...
        SalesOrderCaptionLbl: Label 'Sales Quote';
        SalesOrderNumberCaptionLbl: Label 'Sales Quote Number';
        SalesOrderDateCaptionLbl: Label 'Sales Quote Date';
        ...
        EventsandSubscribersB2B: Codeunit EventsandSubscribers;

report 50011 "Driver Delivery Report"
{
    // NUB1.01,07/01/19,ST: Created new report. This report is copy of "SO Check Sheet".
    // 
    // {
    // Comments Copied from old report
    // *********
    ...
    // }
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Layout/DriverDeliveryReport.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                DataItemTableView = SORTING("Document Type", "Document No.", Type, "No.") WHERE(Type = FILTER(Item));
                ...
                dataitem("Reservation Entry"; "Reservation Entry")
                {
                    ...
                    column(ExpirationDate_ReservationEntry; ResExpDate)
                    {
                    }

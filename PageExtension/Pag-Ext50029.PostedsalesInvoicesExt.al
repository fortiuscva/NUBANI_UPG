...
pageextension 50029 "Posted sales Invoices Ext" extends "Posted Sales Invoices"
{
    ...
    layout
    {
        moveafter("Sell-to Customer Name"; "Order No.")
    ...
    actions
    {
        ...
        // addlast("&Invoice")
        // {
        //     action("Sales - Invoice")  //10074  B2BUPG
        //     {
        //         CaptionML = ENU = 'Sales - Invoice',
        //                          ESM = 'Ventas - Factura',
        //                          FRC = 'Facture de vente',
        //                          ENC = 'Sales - Invoice';
        //         RunObject = Report 10074;
        //         Promoted = false;
        //         Image = Report;

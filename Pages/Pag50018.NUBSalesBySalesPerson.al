...
page 50018 "NUB Sales By SalesPerson"
{
    AdditionalSearchTerms = 'posted bill';
    ApplicationArea = Basic, Suite;
    Caption = 'NUB Sales By SalesPerson';
    CardPageID = "Posted Sales Invoice";
    Editable = false;
    PageType = List;
    QueryCategory = 'NUB Sales By SalesPerson';
    ...
    begin
        CalculateStatisticAmounts(); //adsk
    ...
    local procedure CalculateStatisticAmounts()
    begin
        ClearAll();
    ...
    var
        ...
        AdjProfitLCY, AdjProfitPct, TotalAdjCostLCY, AmountInclVAT : Decimal;
        ...
        AmountLCY, CostLCY, CustAmount, InvDiscAmount, VATAmount : Decimal;
        VATPercentage, ProfitLCY, ProfitPct, CreditLimitLCYExpendedPct : Decimal;
        LineQty, TotalNetWeight, TotalGrossWeight, TotalVolume, TotalParcels : Decimal;
        VATAmountText: Text;
}
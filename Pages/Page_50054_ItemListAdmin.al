page 50054 "Item List- Admin"
{
    ...
    // NUB1.1,10/31/19,SK: Added new action as SKU Label report.
    ...
    actions
    {
        area(navigation)
        {
            ...
            group("Master Data")
            {
                ...
                // action("<Action1100768002>")//14005021 B2BUPG
                // {
            ...
            group(Item)
            {
                ...
                group("Item Reports")
                {
                    ...
                    action("Nonstock Item Sales")
                    {
                        ...
                        //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                        //PromotedCategory = "Report";
                        //RunObject = Report "Nonstock Item Sales";//B2BUPG
